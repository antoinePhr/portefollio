...
<body>
    ...
    <section id="about" class="aboutSection">
        <h1 class="mainSectionTitle">A Propos</h1>
        <div class="imgProfil">
    ...
    <section class="competences">
        <h1 class="sectionCompetencesTitle"> mes compétences</h1>
        <div class="compContainer">
            ...
            <div class="twoPerRow">
                <div class="competence" style="animation-delay: 20ms;">
                    <p>css</p>
                </div>
            </div>
            <div class="twoPerRow">
                <div class="competence" style="animation-delay: 700ms;">
                    <p>js</p>
                </div>
            </div>
            <div class="twoPerRow">
                <div class="competence" style="animation-delay: 900ms;">
                    <p>php</p>
                </div>
            </div>
            <div class="twoPerRow">
                <div class="competence" style="animation-delay: 100ms;">
                    <p>mysql</p>
                </div>
            </div>
            <div class="twoPerRow">
                <div class="competence" style="animation-delay: 300ms;">
                    <p>wordpress</p>
                </div>
            </div>
            ...
            ?>
                <div class="projectCard">
                    <div class="projectImage">
                        ...
                        <h1 class="overlayTitle"><?php echo $row["pj_type"]?></h1>
                        <img src=img/<?php echo $row["pj_image"]?> alt="Illustration du projet">
                    </div>
